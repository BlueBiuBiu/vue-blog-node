...
const { create, detail, list, update, remove, listTotal, profileList, listProfile, addLables, fileInfo, recentList } = require("../controller/moment.controller")
...
momentRouter.get("/recent/moment", recentList)
